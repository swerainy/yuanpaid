...
(function () {
    ...
    s.textContent = [
        ...
        '.activity-content-wrapper{display:grid;grid-template-rows:1fr;overflow:hidden;transition:grid-template-rows .4s cubic-bezier(0.4,0,0.2,1),opacity .4s cubic-bezier(0.4,0,0.2,1);opacity:1;}',
        '.activity-content-wrapper.collapsed{grid-template-rows:0fr!important;opacity:0;}',
        '.activity-content-inner{min-height:0;}',
